  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="space-y-4">
                {recentActivity.map(activity => (
                  <div key={activity.id} className="flex items-start space-x-4 p-3 rounded-xl bg-white/60 hover:bg-white/80 transition-all duration-200">
                    <div className="w-2 h-2 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full mt-2 flex-shrink-0 animate-pulse"></div>
        ...
        <Card variant="cozy" className="p-8 text-center">
          <div className="max-w-2xl mx-auto">
            <div className="w-16 h-16 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4">
              <BookOpen className="w-8 h-8 text-white" />
            </div>
            <blockquote className="text-xl font-medium text-amber-900 mb-3">
              "A room without books is like a body without a soul."
            </blockquote>
            <p className="text-amber-700 text-sm">— Marcus Tullius Cicero</p>
          </div>
        </Card>
